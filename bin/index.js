...
(async () => {
  try {
    ...
    const extensionPackageFromServer = await getExtensionPackageFromServer(envSpecificConfig, accessToken, extensionPackageManifest);
    const extensionPackageId = await uploadZip(envSpecificConfig, accessToken, extensionPackageManifest, extensionPackageFromServer, zipPath);
