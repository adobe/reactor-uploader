...
const argv = require('yargs/yargs')(hideBin(process.argv))
  ...
  .options({
    'access-token': {
      type: 'string',
      describe: 'For authentication using an Adobe I/O integration. The access token. You can generate it for the integration you have created within the Adobe I/O console (https://console.adobe.io).'
    },
    'private-key': {
      type: 'string',
